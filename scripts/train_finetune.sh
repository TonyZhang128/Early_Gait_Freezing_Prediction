...
# ======================== 核心训练参数配置 ========================
# 基础配置
EXP_NAME="Gait_finetune_GSDNN180_baseline"
...
PRETRAINED_MODEL="./save_models/Gait_selfsup_GSDNN_baseline_20260131_192518/checkpoint_epoch_180.pth"  # 预训练模型路径
...
# 保存和日志参数
SAVE_DIR="./save_models"/${EXP_NAME}_${TIME_STAMP}    # 按模型类型分目录
LOG_DIR_TB="./runs"/${EXP_NAME}_${TIME_STAMP}       # TensorBoard日志目录
