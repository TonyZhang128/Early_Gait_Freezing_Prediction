...
class ResNetModel(nn.Module):
    def __init__(self, base_model, num_classes=5):
        ...
        # 添加新的全连接层
        self.linear = nn.Linear(132, 5)  # 移除最后的分类层# 根据ResNet的输出特征图大小调整
...
model.load_state_dict(torch.load('C:/Users/shuli/Desktop/gait_DL4/gait_DL4/gait_SL/save_model/best_modelGSDNN_5class.pth'))
model.eval()

# 加载新数据集
new_gait_data = sio.loadmat('C:/Users/shuli/Desktop/gait_DL4/gait_DL4/data2/midata.mat')['midata']
new_gait_labels = sio.loadmat('C:/Users/shuli/Desktop/gait_DL4/gait_DL4/data2/milabels.mat')['milabels'].flatten()
