...
# 加载数据
gait_data = sio.loadmat('C:/Users/shuli/Desktop/gait_DL4/gait_DL4/data2/all_data.mat')['all_data']
gait_labels = sio.loadmat('C:/Users/shuli/Desktop/gait_DL4/gait_DL4/data2/all_labels.mat')['labels'].flatten()
